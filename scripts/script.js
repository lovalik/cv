function ui() {
  ...
  for( let headerLink of headerLinksCollection) {
  ...
  for( let burgerMenuLink of burgerMenuLinksCollection) {
  ...
  function hideBurgerWhenCyhangeSize(size) {
    ...
    if( window.innerWidth >= 768 && !popupMenu.classList.contains('hide')) {
      ...
      for ( let heading of listItemHeadingCollection) {
